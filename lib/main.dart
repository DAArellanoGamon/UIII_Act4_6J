...
import 'package:arellano0429/firebase_options.dart';
...
class PaginaSesion extends StatelessWidget {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text('Datos incorrectas. Inténtalo de nuevo.'),
            actions: <Widget>[
              TextButton(
                child: const Text('Aceptar',
                    style: TextStyle(color: Color(0xfff92121))),
                onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("Ferreteria Arellano",
            style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xfff92121),
        elevation: 8,
      ),
      body: Padding(
...
class PaginaInicio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Fereteria Arellano',
            style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xfff92121),
        elevation: 8,
      ),
